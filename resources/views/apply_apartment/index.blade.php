                                            ...
                                            <tr>
                                                ...
                                                @if ($data->status == 1)
                                                    <td class="center-icons">
                                                        <a href="{{ route('apply_apartment.edit', $data->apartment_application_id) }}"
                                                            title="edit">
                                                ...
                                                @if ($data->status == 2)
                                                    <td class="center-icons">
                                                        <a href="{{ route('application_extention.edit', $data->apartment_application_id) }}"
                                                            title="create">
                                                            Apply Lease Extention
                                                        </a>
                                                    </td>
                                                @else
                                                    <td class="center-icons">
