                ...
                <div class="card-body">
                    <form action="{{ route('apartments.update', $apartment->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="address" name="address" required>{{ $apartment->address }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="city">City</label>
                            <input type="text" class="form-control" id="city" name="city" value="{{ $apartment->city }}" required>
                        </div>
                        <div class="form-group">
                            <label for="state">State</label>
                            <input type="text" class="form-control" id="state" name="state" value="{{ $apartment->state }}" required>
                        </div>
                        <div class="form-group">
                            <label for="zip_code">Zip Code</label>
                            <input type="text" class="form-control" id="zip_code" name="zip_code" value="{{ $apartment->zip_code }}" required>
                        </div>
                        <div class="form-group">
